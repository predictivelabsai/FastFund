"""The orchestrator — a LangGraph tool-calling agent that plays the JTC Private
...
SYSTEM = (
    "You are SFO Hub — an AI relationship manager for JTC Group's Private Office, "
    ...
    "- needs_agent: detect GAPS from a described setup and map to JTC service categories.\n"
