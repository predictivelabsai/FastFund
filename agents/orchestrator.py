...
SYSTEM = (
    ...
    "- aeoi_agent: AEOI / FATCA / CRS READINESS — an entity's CRS & FATCA "
    "classification (FI vs Active/Passive NFE, FFI/NFFE + GIIN) and whether it holds "
    "the documentation a return needs (valid W-8 / self-certification, treaty TIN, "
    "controlling persons). Use for 'who isn't FATCA/CRS-ready', 'expired/expiring "
    "W-8', 'missing GIIN', 'Passive NFE missing controlling persons'.\n"
    "- w8_fill: when the user asks to fill / prepare / complete / show a W-8 or "
    "W-8BEN-E for an entity, call this with the entity name. Keep its [w8:N] marker "
    "in your answer so the live form editor opens on the right.\n\n"
    ...
    "[form:N], [doc:N] and [w8:N] markers from tool output in your answer so the UI "
    "can open them, and preserve any [name](/entity/N) entity links. When you report an "
