...
"""Generate docs/taxhub_user_guide.pdf from docs/taxhub_user_guide.md.
...
MD = ROOT / "docs" / "taxhub_user_guide.md"
PDF = ROOT / "docs" / "taxhub_user_guide.pdf"

# JTC Group brand palette (jtcgroup.com)
CSS = """
@page { size: A4; margin: 22mm 18mm;
  @bottom-center { content: "JTC TaxHub — User Guide"; font-size: 8pt; color: #9a93a6; }
