...
The domain is a FastFund Family Office relationship-manager simulator. Everything the
app produces — single-family-office (SFO) client profiles, the FastFund service
...
class Storage(abc.ABC):
    ...
    direct analogue of FastFund's citation graph, and what the hybrid engine and a
    ...
    # ── FastFund service catalogue + cross-sell graph ───────────────────────────
    # A Service is a FastFund Family Office offering (trusts, fund admin, luxury asset
