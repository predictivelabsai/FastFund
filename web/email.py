"""Postmark transactional email for FastFund.
...
Env:
  ...
  FROM_NAME           — sender display name (default "FastFund")
...
<div style="font-family:-apple-system,'Segoe UI',Helvetica,Arial,sans-serif;max-width:520px;margin:0 auto;padding:40px 22px;color:#48484f">
  <div style="text-align:center;margin-bottom:28px">
    <div style="display:inline-block;width:46px;height:46px;border-radius:12px;
         background:linear-gradient(135deg,#0f766e,#0b1f33);color:#fff;font-weight:800;
         font-size:22px;line-height:46px">◆</div>
    <p style="font-size:19px;font-weight:700;color:#0b1f33;margin:10px 0 0">FastFund</p>
  ...
  <p style="font-size:14px;line-height:1.65;color:#475569">
    ...
    workspace on FastFund as a <strong>{role}</strong>. FastFund helps fund back-office teams
  ...
  <div style="text-align:center;margin:30px 0">
    <a href="{invite_url}" style="display:inline-block;background:#102a43;color:#fff;
